function generateRespoName() {
    const base = [
        "Respo-Rotation", "Scan-Ghost", "BOERSE", "ID-Gate", "ki3KIme",
        "ECO-MARKT3-EXP168", "SCAN81", "MARKT", "TP4", "TP8", "TP12"
    ];

    const syllables = [
        "Re", "Spo", "Ro", "Ta", "Whirl", "Boost", "Ghost", "Ki", "Me",
        "Gate", "Scan", "Eco", "Exp", "Mark", "TP", "Sys", "Rot", "Flow",
        "Spin", "Loop"
    ];
    ...
    const sliceLen = Math.max(minLen, Math.floor(Math.random() * maxLen));
